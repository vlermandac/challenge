...
def q3_time(file_paths: List[str]) -> List[Tuple[str, int]]:
    """
    Solución q3: versión optimizada para tiempo de ejecución.
    """
...
def q3_memory(file_paths: List[str]) -> List[Tuple[str, int]]:
    """
    Solución q3: versión optimizada para uso de memoria.
    """
